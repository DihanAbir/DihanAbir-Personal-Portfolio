  ...
  const Projects = [
    {
      ...
      description: "I have been working on web design for 1 years.",
    },
    {
      image: project2,
    ...
    <div className="container mx-auto">
      <div className="row">
        ...
        <div className="col-xl-9 col-sm-12">
          ...
          <h3 className="gray">
            Hello! This is{" "}
            <spam className="primary-color"> Md Nahid Murad Abir.</spam>{" "}
          </h3>
          <br />

          <p className="about-me">
            I am currently working with Full-stack web applications. I enjoy
            developing complex Web applications using modern tools and
            technologies including <b>JavaScript</b> , <b>React</b>,{" "}
            <b>Node.js</b>, <b>Express.js</b>, <b>WordPress</b> and writing
            complex Database structure using <b>MongoDB</b> to represent various
            ways to solve business problems.
            <br />
            My goal is to build pixel-perfect, components based and practical
